...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Notification.ReservationActivity, Notification, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", ReservationActivity.class, __md_methods);
	}


	public ReservationActivity () throws java.lang.Throwable
	{
		super ();
		if (getClass () == ReservationActivity.class)
			mono.android.TypeManager.Activate ("Notification.ReservationActivity, Notification, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
